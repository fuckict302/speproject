...
@section('content')
    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="card card-user"style="background-color:black">
                        ...
                        <form method="post" action="contact-us">
                           ...
                           <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label> Subject </label>
                                        <input type="text" class="form-control @error('subject') is-invalid @enderror" placeholder="Subject (Include Student No)" name="subject">
                                        @error('subject')
                                        <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                       </span>
